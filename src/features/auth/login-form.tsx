  ...
  return (
    <div className="relative flex min-h-dvh flex-col bg-[#050505] text-white">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 pt-16">
        <Link href="/" className="grid h-16 w-16 place-items-center rounded-2xl bg-[linear-gradient(145deg,#3b82f6,#60a5fa)] shadow-[0_20px_50px_-20px_rgba(59,130,246,0.7)]">
      ...
      <div className="mx-auto w-full max-w-md space-y-3 px-5 pb-10 animate-auth-rise">
        {!emailMode ? (
          <>
        ...
        {notice ? (
          <p className="rounded-2xl border border-white/8 bg-[#121214] px-4 py-3 text-xs text-white/70" role="status">
            {notice}
          </p>
        ) : null}
      </div>
